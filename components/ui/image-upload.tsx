...
export function ImageUpload({ images, onChange, maxImages = 5, className = '', useCloudUpload = false }: ImageUploadProps) {
    ...
    <div className={`space-y-4 ${className}`}>
      ...
      {images.length > 0 && (
        <div className="space-y-3">
          <p className="text-sm">Uploaded Images ({images.length}/{maxImages})</p>
