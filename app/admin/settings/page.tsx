...
export default function AdminSettingsPage() {
  ...
  const [settings, setSettings] = useState({
    ...
    metaDescription: 'Discover authentic Islamic books, Quran translations, Hadith collections, and Islamic literature for all ages.',
    metaKeywords: 'islamic books, quran, hadith, islamic literature, muslim books',
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('standardShippingCost', parseFloat(e.target.value))}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('expressShippingCost', parseFloat(e.target.value))}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => {
                        const newZones = [...settings.shippingZones, { name: '', cost: 0 }]
                        handleSettingChange('shippingZones', newZones)
                      }}
                    >
                      Add Zone
